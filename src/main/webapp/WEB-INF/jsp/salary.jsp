        ...
        <div class="main">
            <div id="salary">
            	...
            	<table class="table table-striped">
        			...
        			<tbody>        				
        				<c:forEach var="listValue" items="${salaryList}"> 
        					<tr>                
               		 			<td>${'$'} ${listValue.salary} </td>
               					<td><fmt:formatDate pattern="yyyy-MM-dd" value="${listValue.fromDate}"/></td>
               					<td>
               						<c:if test = "${listValue.toDate eq '9999-01-01 00:00:00.0'}">
               							Current
               						</c:if>
               						
               						<c:if test = "${listValue.toDate ne '9999-01-01 00:00:00.0'}">
               							<fmt:formatDate pattern="yyyy-MM-dd" value="${listValue.toDate}"/>
	            					</c:if>	
               					</td>
               				</tr>
               			 </c:forEach>
